...
const headphoneData = [
  {
    ...
    subtitle:
      "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nemo, quia. Magnam iusto quaerat deleniti nisi natus eligendi voluptatem? Libero, voluptatibus!",
    Price: "$100",
    Modal: "Modal  Brown",
    bgColor: "#8b5958",
  },
          ...
          <div className="flex flex-col justify-center py-14 md:py-0 xl:max-w-[500px]">
            <div className="space-y-5 md:text-left text-center ">
              ...
              <AnimatePresence mode="wait">
                <UpdateFollower
                  mouseOptions={{
                    backgriundColor: activeData.bgColor,
                    zIndex: 9999,
                    followSpeed: 0.5,
                    rotate: -720,
                    scale: 6,
          ...
          <div className="flex flex-col justify-end items-center">
            <AnimatePresence mode="wait">
              <motion.img
                ...
                alt=""
                className="w-[300px] md:w-[400px] xl-[550px]"
              />
            </AnimatePresence>
          </div>
