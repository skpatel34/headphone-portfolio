      ...
      <footer className='bg-primary pt-12 pb-8 text-white'>
        <div className="container">
          ...
          <motion.div 
            ...
            <p className='text-sm max-w-[300px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe cumque deserunt ullam natus doloribus. Molestiae deleniti ea autem id esse!</p>
            <div>
